...
export const heroData: HeroData = {
  ...
  about:
    'Me especializo en el desarrollo de mecánicas. Disfruto profundamente tomar la iniciativa, guiar equipos y transformar ideas complejas en experiencias interactivas pulidas y divertidas. Para mí, el desarrollo es un aprendizaje constante, por eso me encanta compartir lo que sé con otros y rodearme de personas que me desafíen a mejorar cada día.',
  softSkills:
    'Soy muy tenaz, me gusta comprometerme, adaptarme a lo que venga manteniendo un horizonte. Hay muchos caminos para llegar a él, soy paciente y sé comunicarme de manera asertiva.',
  hardSkills:
    'Manejo de C#, Unity, GitHub. Próximamente otros motores de desarrollo...',
  contact: {
    linkedin: '#',
    github: '#',
    itch: '#',
  ...
  skills: [
    {
      ...
      items: ['Diseño de juegos generalista', 'Diseño narrativo', 'Gamificación'],
    },
    {
      category: 'Producción',
...
export const projectsData: ProjectData[] = [
  {
    ...
    platform: '[Plataforma]',
    description:
      '[Descripción general del juego — completar más tarde]',
    categories: ['Codificación', 'Artista Técnica', 'UX/UI', 'Arte', 'Narrativa'],
    responsibilities:
